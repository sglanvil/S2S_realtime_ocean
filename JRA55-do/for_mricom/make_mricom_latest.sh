...
#or item in slprs brtmp ice tmp10m sph10m u10m v10m dswrf dlwrf prcp snow rain # rain is processed in step 7
for item in slprs brtmp ice tmp10m sph10m u10m v10m dswrf dlwrf prcp snow 
do
