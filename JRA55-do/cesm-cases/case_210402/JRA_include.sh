...
DAYe=2       # end date: day of month
ODAYe=92      # end date: ordinal day
DATESTRe=20210402 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=4      # day after end date: month of year
DAYp=3       # day after end date: day of month
