...
DAYe=1       # end date: day of month
ODAYe=152      # end date: ordinal day
DATESTRe=20210601 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=6      # day after end date: month of year
DAYp=2       # day after end date: day of month

DATESTRc=20210601 # file creation date text string for netCDF file name
