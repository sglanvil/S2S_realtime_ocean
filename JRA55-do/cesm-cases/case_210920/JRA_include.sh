...
ODAYe=263      # end date: ordinal day
DATESTRe=20210920 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=9      # day after end date: month of year
DAYp=21       # day after end date: day of month

DATESTRc=20210920 # file creation date text string for netCDF file name
