...
MONTHe=4      # end date: month of year
DAYe=30       # end date: day of month
ODAYe=120      # end date: ordinal day
DATESTRe=20210430 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=5      # day after end date: month of year
DAYp=1       # day after end date: day of month

DATESTRc=20210430 # file creation date text string for netCDF file name
