...
ODAYe=106      # end date: ordinal day
DATESTRe=20210416 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=4      # day after end date: month of year
DAYp=17       # day after end date: day of month

DATESTRc=20210416 # file creation date text string for netCDF file name
