...
MONTHe=8      # end date: month of year
DAYe=27       # end date: day of month
ODAYe=239      # end date: ordinal day
DATESTRe=20210827 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=8      # day after end date: month of year
DAYp=28       # day after end date: day of month

DATESTRc=20210827 # file creation date text string for netCDF file name
