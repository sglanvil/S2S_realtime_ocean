...
ODAYe=176      # end date: ordinal day
DATESTRe=20210625 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=6      # day after end date: month of year
DAYp=26       # day after end date: day of month

DATESTRc=20210625 # file creation date text string for netCDF file name
