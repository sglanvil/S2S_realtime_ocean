...
MONTHe=2      # end date: month of year
DAYe=28       # end date: day of month
ODAYe=59      		# end date: ordinal day
DATESTRe=20210228 	# end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=3      # day after end date: month of year
DAYp=1       # day after end date: day of month

DATESTRc=20210322 # file creation date text string for netCDF file name
