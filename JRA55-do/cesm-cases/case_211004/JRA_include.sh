...
ODAYe=277      # end date: ordinal day
DATESTRe=20211004 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=10      # day after end date: month of year
DAYp=5       # day after end date: day of month

DATESTRc=20211004 # file creation date text string for netCDF file name
