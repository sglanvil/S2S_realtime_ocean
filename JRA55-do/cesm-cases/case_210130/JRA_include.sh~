...
MONTHe=1      # end date: month of year
DAYe=30       # end date: day of month
ODAYe=30      # end date: ordinal day
DATESTRe=20210130 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=1      # day after end date: month of year
DAYp=31       # day after end date: day of month
# ODAYp=17      # day after end date: ordinal day  # not used

DATESTRc=20210225 # file creation date text string for netCDF file name
