...
DAYe=4       # end date: day of month
ODAYe=155      # end date: ordinal day
DATESTRe=20210604 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=6      # day after end date: month of year
DAYp=5       # day after end date: day of month

DATESTRc=20210604 # file creation date text string for netCDF file name
