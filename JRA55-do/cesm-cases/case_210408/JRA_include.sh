...
DAYe=8       # end date: day of month
ODAYe=98      # end date: ordinal day
DATESTRe=20210408 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=4      # day after end date: month of year
DAYp=9       # day after end date: day of month

DATESTRc=20210408 # file creation date text string for netCDF file name
