...
MONTHe=9      # end date: month of year
DAYe=17       # end date: day of month
ODAYe=260      # end date: ordinal day
DATESTRe=20210917 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=9      # day after end date: month of year
DAYp=18       # day after end date: day of month

DATESTRc=20210917 # file creation date text string for netCDF file name
