...
ODAYe=211      # end date: ordinal day
DATESTRe=20210730 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=7      # day after end date: month of year
DAYp=31       # day after end date: day of month

DATESTRc=20210730 # file creation date text string for netCDF file name
