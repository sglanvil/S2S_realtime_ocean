...
DAYe=11       # end date: day of month
ODAYe=162      # end date: ordinal day
DATESTRe=20210611 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=6      # day after end date: month of year
DAYp=12       # day after end date: day of month

DATESTRc=20210611 # file creation date text string for netCDF file name
