...
DAYe=9       # end date: day of month
ODAYe=190      # end date: ordinal day
DATESTRe=20210709 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=7      # day after end date: month of year
DAYp=10       # day after end date: day of month

DATESTRc=20210709 # file creation date text string for netCDF file name
