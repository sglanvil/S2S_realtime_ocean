...
MONTHe=5      # end date: month of year
DAYe=7       # end date: day of month
ODAYe=127      # end date: ordinal day
DATESTRe=20210507 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=5      # day after end date: month of year
DAYp=8       # day after end date: day of month

DATESTRc=20210507 # file creation date text string for netCDF file name
