...
MONTHe=6      # end date: month of year
DAYe=18       # end date: day of month
ODAYe=169      # end date: ordinal day
DATESTRe=20210618 # end date: text string for netCDF file name

YEARp=2021    # end date: year 
MONTHp=6      # day after end date: month of year
DAYp=19       # day after end date: day of month

DATESTRc=20210618 # file creation date text string for netCDF file name
