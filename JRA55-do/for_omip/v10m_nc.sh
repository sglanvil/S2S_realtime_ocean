...
flin="${datahome}/version_1_5/grads/2022/v10m."
flout="${nchome}/version_1_5/netCDF/v_10.2022.20220321.nc"
flctl="${nchome}/version_1_5/netCDF/v_10.2022.ctl"
...
&nml_vars
 ...
 vname_tmp='vas_10m'
 vunit_tmp='m/s',
 vlongname_tmp='Northward Near-Surface Wind'
 vstandardname_tmp='northward_wind'
 rconv_tmp=1.0,
 rmin_tmp=-9.99e33,
 rmax_tmp=9.99e33,
...
&nml_global_attributes
  global_attributes%title="Adjusted Y-ward 10 m wind of JRA55-do"
