...
flin="${datahome}/version_1_5/grads/2022/sph10m."
flout="${nchome}/version_1_5/netCDF/q_10.2022.20220321.nc"
flctl="${nchome}/version_1_5/netCDF/q_10.2022.ctl"
...
&nml_vars
 ...
 vname_tmp='huss_10m'
 vunit_tmp='kg/kg',
 vlongname_tmp='Near-Surface Specific Humidity at the 10 meter height'
 vstandardname_tmp='specific_humidity'
 rconv_tmp=1.0,
 rmin_tmp=-9.99e33,
 rmax_tmp=9.99e33,
...
&nml_global_attributes
  global_attributes%title="Adjusted 10 m specific humidity of JRA55-do"
