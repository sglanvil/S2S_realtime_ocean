...
flin="${datahome}/version_1_5/grads/2022/slprs."
flout="${nchome}/version_1_5/netCDF/slp.2022.20220321.nc"
flctl="${nchome}/version_1_5/netCDF/slp.2022.ctl"
...
&nml_vars
 ...
 vname_tmp='psl'
 vunit_tmp='Pa',
 vlongname_tmp='Sea Level Pressure'
 vstandardname_tmp='air_pressure_at_sea_level'
 rconv_tmp=1.0,
 rmin_tmp=-9.99e33,
 rmax_tmp=9.99e33,
...
&nml_global_attributes
  global_attributes%title="Sea level pressure of JRA55-do"
