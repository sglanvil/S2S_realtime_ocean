...
flin="${datahome}/version_1_5/grads/2022/rain."
flout="${nchome}/version_1_5/netCDF/rain.2022.20220321.nc"
flctl="${nchome}/version_1_5/netCDF/rain.2022.ctl"
...
&nml_vars
 ...
 vname_tmp='prrn'
 vunit_tmp='kg/m2/s',
 vlongname_tmp='Precipitation of water in liquid phase'
 vstandardname_tmp='rainfall_flux'
 rconv_tmp=1.0,
 rmin_tmp=-9.99e33,
 rmax_tmp=9.99e33,
...
&nml_global_attributes
  global_attributes%title="Adjusted rain fall rate of JRA55-do"
