...
flin="${datahome}/version_1_5/grads/2022/dlwrf."
flout="${nchome}/version_1_5/netCDF/rlds.2022.20220321.nc"
flctl="${nchome}/version_1_5/netCDF/rlds.2022.ctl"
...
&nml_vars
 ...
 vname_tmp='rlds'
 vunit_tmp='W/m2',
 vlongname_tmp='Surface Downwelling Longwave Radiation'
 vstandardname_tmp='surface_downwelling_longwave_flux_in_air'
 rconv_tmp=1.0,
 rmin_tmp=-9.99e33,
 rmax_tmp=9.99e33,
...
&nml_global_attributes
  global_attributes%title="Adjusted surface downwelling longwave radiation of JRA55-do"
